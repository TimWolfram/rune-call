<template>
  ...
  <v-container v-else class="d-flex flex-wrap">
    <RoomListItem class="d-flex align-content-space-around flex-wrap bg-surface-variant" :room="room"
...
<script>
import RoomListItem from '@/components/troefcall/room/RoomListItem.vue';
export default {
  name: "RoomList",
  components: {
    RoomListItem
